        ...
        <div className="w-full max-w-lg">
          ...
          <div className="bg-slate-900/90 backdrop-blur-md border border-slate-800 rounded-2xl shadow-2xl p-6 sm:p-8 space-y-6">
            ...
            {tab !== 'ADMIN_LOGIN' ? (
              ...
              <div className="flex items-center justify-between p-3 bg-indigo-950/70 border border-indigo-800/80 rounded-xl text-xs">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder={tab === 'ADMIN_LOGIN' ? 'admin@apex.edu' : 'yourname@apex.edu'}
