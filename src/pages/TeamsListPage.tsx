  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-200">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 sm:p-7 rounded border border-slate-200 shadow-2xs text-slate-900">
        <div>
          <h1 className="font-serif-academic text-xl sm:text-2xl font-bold text-[#0B1E36] flex items-center gap-2">
            <FolderGit2 className="w-5 h-5 text-[#0B1E36]" /> Academic Projects Directory
          </h1>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 bg-white border border-slate-300 rounded text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-[#0B1E36]"
          />
        </div>
        ...
        <select
          ...
          className="px-3 py-2 bg-white border border-slate-300 rounded text-xs font-semibold text-slate-800 focus:outline-none focus:ring-1 focus:ring-[#0B1E36]"
        >
          ...
          {filteredProjects.map((proj) => {
            ...
            return (
              <Card
                ...
                className="p-5 sm:p-6 flex flex-col justify-between cursor-pointer hover:border-slate-300 group transition-all"
              >
                <div className="space-y-3">
                  <div className="flex justify-between items-start gap-2">
                    <div>
                      ...
                      <h3 className="font-serif-academic font-bold text-[#0B1E36] text-base group-hover:text-blue-800 transition-colors line-clamp-1">
                        {proj.name}
                      </h3>
                    </div>
                ...
                <div className="mt-5 pt-3 border-t border-slate-100 flex items-center justify-between text-xs">
                  ...
                  <span className="text-[#0B1E36] font-bold flex items-center gap-1 group-hover:translate-x-0.5 transition-transform">
